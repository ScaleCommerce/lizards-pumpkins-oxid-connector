 ...
 */
    ...
    $this->dbHost = '10.1.25.9'; // database host name
    $this->dbName = 'oxid'; // database name
    $this->dbUser = 'oxid'; // database user name
    $this->dbPwd = 'WWUBfyy4cyACwCnALFtcpaxc'; // database user password
    $this->dbType = 'mysql';
    $this->sShopURL = 'http://lizard.sc-demo.de'; // eShop base url, required
    $this->sSSLShopURL  = null;            // eShop SSL url, optional
    $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
    $this->sShopDir = '/var/www/lizard.sc-demo.de/web';
    $this->sCompileDir = '/var/www/lizard.sc-demo.de/web/tmp';
     ...
     */
    $this->captchaKey = 'd1b770b293b7700b25402d25b8f73a78';
